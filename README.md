...
The Mentor of this project is [Alba Cervera-Lierta](https://albacl.github.io). <br> Additionally, a list of relevant publications and papers is provided in [here.](https://github.com/akropf/SchwingerModel/blob/main/Papers/PaperList.md)
## Abstract
